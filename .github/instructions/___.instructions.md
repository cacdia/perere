...
- **Next.js 15 (App Router)**: Use the App Router for routing and layout. Structure pages in `app/` directory with `page.tsx` files.
- **React 19**: Leverage the latest React features, such as hooks and concurrent rendering.
...
- **Node.js 20+**: Ensure your environment runs Node.js version 20 or higher.
- **Tools**:
...
YOU SHALL NOT:
- NEST TERNARY OPERATORS (i.e., `condition ? expr1 : expr2 ? expr3 : expr4`)